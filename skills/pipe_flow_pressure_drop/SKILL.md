...
description: >-
  Estimate single-phase incompressible pipe pressure drop, Reynolds number, Darcy friction factor, and head loss. Use when a user asks for chemical engineering, process engineering, applied science, or statistics work matching this scope.
---
...
Estimate single-phase incompressible pipe pressure drop, Reynolds number, Darcy friction factor, and head loss.
...
- `uv run scripts/pipe_pressure_drop.py`
