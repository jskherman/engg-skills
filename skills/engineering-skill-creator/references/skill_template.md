...
Copy this and replace the bracketed placeholders. This follows the Agent Skills
...
- The parent folder name must match the frontmatter `name`; use a lowercase
  hyphenated slug with no leading, trailing, or consecutive hyphens.
