...
description: >-
  Calculate Reynolds, Prandtl, Schmidt, Peclet, Froude, Weber, Biot, Fourier, and related dimensionless numbers. Use when a user asks for chemical engineering, process engineering, applied science, or statistics work matching this scope.
---
...
Calculate Reynolds, Prandtl, Schmidt, Peclet, Froude, Weber, Biot, Fourier, and related dimensionless numbers.
...
- `uv run scripts/calculate_dimensionless.py`
