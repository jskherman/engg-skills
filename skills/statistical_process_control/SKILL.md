...
description: >-
  Create preliminary SPC summaries: individuals charts, Xbar-R charts, and capability metrics. Use when a user asks for chemical engineering, process engineering, applied science, or statistics work matching this scope.
---
...
Create preliminary SPC summaries: individuals charts, Xbar-R charts, and capability metrics.
