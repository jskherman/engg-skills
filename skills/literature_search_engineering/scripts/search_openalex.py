...
def main():
    ...
    try:
        ...
        path=write_json(result_envelope(skill='literature_search_engineering', inputs=vars(a), results={'query_url':url,'items':items}, sources=['https://docs.openalex.org/']), a.output); print(f'Success. JSON written to: {path}'); return 0
