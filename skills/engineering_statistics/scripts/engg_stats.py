...
def main():
    ...
    try:
        ...
        path=write_json(result_envelope(skill='engineering_statistics', inputs=vars(a), results=res, warnings=warnings), a.output); print(f'Success. JSON written to: {path}'); return 0
    except Exception as e:
        write_json(result_envelope(skill='engineering_statistics', inputs=vars(a), results={'error':str(e)}, ok=False), a.output); print(f'Error. JSON written to: {a.output}', file=sys.stderr); return 1
