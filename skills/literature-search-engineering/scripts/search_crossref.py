...
def main():
    ...
    try:
        ...
        data=result_envelope(skill=SKILL, inputs=vars(a), results={'query_url':url,'items':items}, sources=['https://www.crossref.org/documentation/retrieve-metadata/rest-api/'])
