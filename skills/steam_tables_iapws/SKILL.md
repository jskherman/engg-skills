...
description: >-
  Calculate water/steam properties with optional IAPWS dependency and graceful fallback guidance. Use when a user asks for chemical engineering, process engineering, applied science, or statistics work matching this scope.
---
...
Calculate water/steam properties with optional IAPWS dependency and graceful fallback guidance.
