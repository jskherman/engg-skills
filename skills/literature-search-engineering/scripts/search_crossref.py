...
def main():
    ...
    try:
        ...
        path=write_json(result_envelope(skill='literature-search-engineering', inputs=vars(a), results={'query_url':url,'items':items}, sources=['https://www.crossref.org/documentation/retrieve-metadata/rest-api/']), a.output); print(f'Success. JSON written to: {path}'); return 0
