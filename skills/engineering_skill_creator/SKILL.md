...
description: >-
  Create new engineering skills consistently with SKILL.md, scripts, references, tests, safety notices, and JSON outputs. Use when a user asks for chemical engineering, process engineering, applied science, or statistics work matching this scope.
---
...
Create new engineering skills consistently with SKILL.md, scripts, references, tests, safety notices, and JSON outputs.
