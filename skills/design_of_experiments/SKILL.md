...
description: >-
  Generate and analyze simple engineering DOE plans such as full factorial and two-level designs. Use when a user asks for chemical engineering, process engineering, applied science, or statistics work matching this scope.
---
...
Generate and analyze simple engineering DOE plans such as full factorial and two-level designs.
